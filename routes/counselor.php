...
Route::middleware(['auth', 'counselor'])
    ...
    ->group(function () {
        ...
        Route::delete('/availability', [CounselorAvailabilityController::class, 'bulkDestroy'])->name('availability.bulkDestroy');
        ...
        Route::get('/appointments/{id}/follow-up',     [CounselorAppointmentController::class, 'followUpForm'])->whereNumber('id')->name('appointments.follow.form');
