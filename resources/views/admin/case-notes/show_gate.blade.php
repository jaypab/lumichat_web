{{-- resources/views/admin/case-notes/show_gate.blade.php --}}
      ...
      <div class="flex items-start gap-3">
        ...
        <div class="flex-1">
          ...
          <p class="mt-1 text-sm text-slate-600">
            Case notes may contain very sensitive details from counseling sessions.
            For your safety and the student’s privacy, please confirm your password
            before viewing this case note.
          </p>
...
<div id="gateModal"
  ...
  <div class="relative z-[71] w-full max-w-md origin-center scale-95 opacity-0 translate-y-2
    ...
    <form id="gateForm" class="mt-4 space-y-4" novalidate>
      @csrf
      <input type="hidden" name="case_note_id" value="{{ $noteId }}">
