...
<head>
    ...
    <title>404 - Page Not Found | LumiChat</title>
    ...
    <div class="relative min-h-screen w-full flex items-center justify-center overflow-hidden">
        ...
        <div class="relative z-10 p-6 max-w-lg w-full text-center">
            <div class="glass-card relative bg-white/5 backdrop-blur-3xl rounded-[2.5rem] p-10 sm:p-14 shadow-2xl">
                <h1 class="text-8xl font-bold bg-gradient-to-br from-violet-400 to-fuchsia-400 bg-clip-text text-transparent opacity-50 mb-4 selection:bg-transparent">404</h1>
                <h2 class="text-2xl font-bold mb-4">Lost in the Glow?</h2>
                ...
                <div class="flex flex-col sm:flex-row gap-4 justify-center">
                    <a href="/" class="px-8 py-4 rounded-2xl bg-gradient-to-r from-violet-600 to-fuchsia-600 font-semibold hover:scale-[1.02] active:scale-[0.98] transition-all shadow-lg shadow-violet-500/20">
                        Back to Portal
                    </a>
                </div>
            </div>
