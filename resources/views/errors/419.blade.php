...
<head>
    ...
    <title>419 - Page Expired | LumiChat</title>
    ...
    <div class="relative min-h-screen w-full flex items-center justify-center overflow-hidden">
        ...
        <div class="relative z-10 p-6 max-w-lg w-full text-center">
            <div class="glass-card relative bg-white/5 backdrop-blur-3xl rounded-[2.5rem] p-10 sm:p-14 shadow-2xl">
                <h1 class="text-8xl font-bold bg-gradient-to-br from-violet-400 to-fuchsia-400 bg-clip-text text-transparent opacity-50 mb-4 selection:bg-transparent">419</h1>
                <h2 class="text-2xl font-bold mb-4">Your Session Expired</h2>
                <p class="text-white/60 mb-10 leading-relaxed">
                    Oops! It looks like you've been inactive for a while. To keep your information safe, your session has timed out. Just refresh to continue!
                </p>
