  ...
  <form id="pwd-form" method="post" action="{{ route('password.update') }}" class="mt-6 space-y-5" novalidate>
    ...
    <div>
      ...
      <div class="relative">
        ...
        <button type="button" class="reveal-btn" data-target="pwd_current" aria-label="Show current password"
          aria-pressed="false">
    ...
    <div>
      ...
      <div class="relative">
        <x-text-input id="pwd_new" name="password" type="password" class="mt-1 block w-full input-dynamic pr-10"
          autocomplete="new-password" />
        <button type="button" class="reveal-btn" data-target="pwd_new" aria-label="Show new password"
          aria-pressed="false">
          <img class="eye-img" src="{{ asset('images/icons/eye-off.png') }}" alt="">
        </button>
      </div>
    ...
    <div>
      ...
      <div class="relative">
        ...
        <button type="button" class="reveal-btn" data-target="pwd_confirm" aria-label="Show confirm password"
          aria-pressed="false">
          <img class="eye-img" src="{{ asset('images/icons/eye-off.png') }}" alt="">
        </button>
      </div>
...
@push('styles')
  <style>
    ...
    .meter-fill {
      height: 100%;
      width: 0%;
      background: linear-gradient(90deg, #f87171, #f59e0b, #34d399, #22c55e);
